...
//  lấy giá trị của tham số 'id_phong' từ request gửi đến server
    $id_phong = $_REQUEST['id_phong'];
    // lấy giá trị của 'id_useradmin' từ biến phiên ('$_SESSION') được lưu trữ trên máy chủ.
    $id_useradmin = $_SESSION['user_admin']['id_useradmin'];
// Dòng này gọi một hàm có tên là 'loadBinhLuan' với tham số 'id_phong' và gán kết quả trả về vào biến '$listbinhLuan'. 
//  để tải danh sách các bình luận liên quan đến phòng có 'id_phong' tương ứng
...
<div class="container container-comment">
    <div class="comment">    
        <div id="hotels-title" class="hotels-title">
            ...
            <ul>
                <li>Mô tả</li>
                <!-- hiển thị nhận xet bằng foreach -->
                <?php 
